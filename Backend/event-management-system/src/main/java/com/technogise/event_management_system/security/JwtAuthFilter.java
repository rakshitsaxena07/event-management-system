...
public class JwtAuthFilter
    extends OncePerRequestFilter { // this filter will run once per http request
    ...
    if (email != null) {
      ...
      UsernamePasswordAuthenticationToken authentication =
          new UsernamePasswordAuthenticationToken(
              email, null,
              List.of()); // creates authentication token with email as principal, no credentials,
      // and empty authority list(roles)
